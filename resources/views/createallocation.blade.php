                ...
                <div class="card-body">
                    <form action="{{ route('allocation.store') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="" name="Type_allocation_familiale">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Valeur d'allocation</label>
                            <input type="text" class="form-control" placeholder="" name="Valeur_allocation_familiale">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Date d'allocation</label>
                            <input type="date" class="form-control" placeholder="Entrer le DRPP d'employé" name="date_allocation">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">DRPP</label>
                            <input type="text" class="form-control" placeholder="Entrer la justification" name="DRPP">
                        </div>
                        <div class="mb-3">
