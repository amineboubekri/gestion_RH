    ...
    <div class="row my-4" align="center">
        <div class="col-md-8 mx-auto">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('conge.store', $personne->DRPP) }}" method="post">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="texr" class="form-control" placeholder="Entrer le DRPP de l'employé" 
                            value="{{ $personne->DRPP }}" 
                            name="DRPP" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Nom</label>
                            <input type="texr" class="form-control" placeholder="" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" placeholder="" name="nbj" id="nbj-input">
                        </div>
                        <div class="mb-3">
