    ...
    <div class="row my-4" align="center">
        <div class="col-md-8 mx-auto">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('diplome.store', $personne->DRPP) }}" method="post">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Entrer le nom de diplome" name="Nom_diplome">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Specialité</label>
                            <input type="text" class="form-control" placeholder="Entrer la specialité" name="Specialite">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Date d'obtention</label>
                            <input type="date" class="form-control" placeholder="" name="Date_obtention">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Ecole</label>
                            <input type="text" class="form-control" placeholder="Entrer l'ecole" name="Ecole">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Ville d'obtention</label>
                            <input type="text" class="form-control" placeholder="Enter la ville" name="Ville_diplome">
                        </div>
