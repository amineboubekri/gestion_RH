...
<html>
<head>
	<title>Allocation {{ $personne->DRPP }} PDF</title>
    <style>
      table {
...
<body>
	...
	<table>
		<tr>
			<th colspan="2">Informations d'allocation</th>
		</tr>
		<tr>
			<td>Type d'allocation</td>
			<td>{{ $allocations->Type_allocation_familiale }}</td>
		</tr>
		<tr>
			<td>Valeur d'allocation</td>
			<td>{{ $allocations->Valeur_allocation_familiale }}</td>
		</tr>
        <tr>
			<td>Date d'allocation</td>
