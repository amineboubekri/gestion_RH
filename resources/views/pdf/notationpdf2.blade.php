...
<html>
<head>
	<title>Notation {{ $personne->DRPP }} PDF</title>
    <style>
      table {
...
<body>
	...
	<table>
		<tr>
			<th colspan="2">Informations du notation</th>
		</tr>
		<tr>
			<td>Note appliquée</td>
			<td>{{ $notations->Note_appliquee }}</td>
		</tr>
        <tr>
			<td>Note de rentabilité</td>
			<td>{{ $notations->Note_rentabilite }}</td>
		</tr>
        <tr>
			<td>Note de capacité</td>
			<td>{{ $notations->Note_capacite }}</td>
		</tr>
        <tr>
			<td>Note du comportement professionnel</td>
			<td>{{ $notations->Note_comportement_professionnel }}</td>
		</tr>
        <tr>
			<td>Note de recherche</td>
